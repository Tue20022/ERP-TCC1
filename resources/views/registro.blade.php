            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image">
                        <img src="/img/img_login.jpg" alt="Login Image" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5 mt-5">
                            ...
                            <form  action="{{ route('registrar') }}" method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            name="password_confirmation" id="password_confirmation" placeholder="Repita a Senha" required>
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <a class="small" href="{{route('login')}}">Já possuí uma conta? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
